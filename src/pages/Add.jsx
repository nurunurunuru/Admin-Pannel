      ...
      <div className='flex flex-col gap-y-2 medium-15'>
        ...
        <div className='flex gap-2 pt-2'>
          <label htmlFor='image1'>
            <img src={image1 ? URL.createObjectURL(image1) : Upload} alt="" className='w-16 h-16 aspect-square object-cover ring-1 ring-slate-900/5 rounded-lg'/>
            <input onChange={(e) => setImage1(e.target.files[0])} type="file" name='image' id='image1' hidden />
          </label>
          <label htmlFor='image2'>
            <img src={image2 ? URL.createObjectURL(image2) : Upload} alt="" className='w-16 h-16 aspect-square object-cover ring-1 ring-slate-900/5 rounded-lg'/>
            <input onChange={(e) => setImage2(e.target.files[0])} type="file" name='image' id='image2' hidden  />
          </label>
          <label htmlFor='image3'>
            <img src={image3 ? URL.createObjectURL(image3) : Upload} alt="" className='w-16 h-16 aspect-square object-cover ring-1 ring-slate-900/5 rounded-lg'/>
            <input onChange={(e) => setImage3(e.target.files[0])} type="file" name='image' id='image3' hidden  />
          </label>
          <label htmlFor='image4'>
            <img src={image4 ? URL.createObjectURL(image4) : Upload} alt="" className='w-16 h-16 aspect-square object-cover ring-1 ring-slate-900/5 rounded-lg'/>
      ...
      <div>
        <div className='flex flex-col sm:flex-row gap-4'>
          <div className='flex flow-row gap-4'>
            ...
            <div>
              ...
              <select onChange={(e)=>setSubCategory(e.target.value)} className="max-w-20 px-3 py-2 text-gray-30 ring-1 ring-slate-900/5 bg-white rounded">
        ...
        <div>
          ...
          <div className='flex gap-3 mt-2'>
            ...
            <div onClick={()=> setSizes(prev => prev.includes("XXL") ? prev.filter(item=> item !== "XXL") : [...prev,"XXL"])}><span className={`${sizes.includes("XXL") ? "bg-tertiary text-white" : "bg-white"} text-gray-30 rounded ring-1 ring-slate-900/5 px-3 py-1 cursor-pointer`}>XLL</span></div>
          </div>
        </div>
